...
public class UserDaoImpl implements IUserDao {
	...
	public User queryByUserId(String userId) {
		...
		StringBuilder sql = new StringBuilder("select uid from test where uid=?");
...
*/				return user;
	...
	public void save(User user) {
		...
		StringBuilder sql = new StringBuilder("insert into test(uid) values(?)");
		this.jdbcTemplate.update(sql.toString(), new Object[] { user.getUserId()});
	}
}
